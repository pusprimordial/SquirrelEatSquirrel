...
def runGame():
    ...
    gameOverStartTime = 0 # time the pĺayer lost
    ...
    # start off with some random grass images on the screene
    for i in range(10):
    ...
    while True: #main game loop
        # check if if we turn off invulnerability
        ...
        for event in pygame.event.get():
            if event.type == QUIT:
                ...
                #stop moving the player squirrel
        ...
        if not gameOverMode:
            ...
            if time.time() - gameOverStartTime > GAMEOVERTIME:
                return #end the curent game and display game over on the screen
...
def drawHealthMeter(currentHealth):
    ...
    for i in range (MAXHEALTH): #draw the white outlines
        pygame.draw.rect(DISPLAYSURF, WHITE,  (15, 5 + (10* MAXHEALTH) - 1 * 10, 20, 10), 1)
...
def getBounceAmount(currentBounce, bounceRate, bounceHeight):
    ...
    #latger bounceRate means a slower bounce
...
def getRandomOffCameraPos(camerax, cameray, objWidth, objHeight):
    ...
    while True:
        ...
        # to make sure teh right ege isn't in the camera view
...
def isOutsideActiveArea(camerax, cameray, obj):
    #retrun false if camerax and cameray are more than
